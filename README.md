...
## Executive Summary
This Power BI project analyzes healthcare data for 1,000 patients across 5 hospitals, focusing on patient demographics, treatment outcomes, and associated costs. The dashboard uncovers actionable insights — such as identifying high-recovery, cost-effective treatments and tailoring care strategies based on age and gender. These findings support data-driven decision-making, helping improve both patient outcomes and hospital efficiency.

## Tools and Skills
- **Power BI**: Built dynamic dashboards and interactive visuals.
- **Data Analysis**: Explored trends in demographics, costs, and outcomes.
- **Statistical Analysis**: Used correlation and variance analysis for actionable insights.
- **Healthcare Understanding**: Interpreted data in context of clinical operations.
